...
function MovieWatchCard({ details }) {
  ...
  return loading ? (
    ...
    <div className="movie-card-detail to-transparent w-[93%] h-[100%] rounded-lg mx-auto relative hover:cursor-pointer md:w-[93%] min-[360px]:w-[100%]">
      <div className="content flex justify-between lg:static sm:relative min-[360px]:relative">
        <div className="text w-[50%] py-16 pl-16 relative z-40 lg:relative sm:absolute min-[360px]:absolute sm:left-0 sm:py-8 md:w-[50%] min-[360px]:py-4 min-[360px]:w-[85%]">
          <p className="text-white xl:text-3xl font-extrabold mb-2 lg:text-xl md:text-xl sm:text-lg min-[360px]:text-sm">
            {details.title}
          </p>
