...
export const getComedyMovies = async () => {
  const responseHi = await fetch(
    movieURL("release_date.desc", "35", "", "hi", "122")
  );
  const responseEn = await fetch(
    movieURL("release_date.desc", "35", "", "en", "122")
  );
...
export const getComedyShows = async () => {
  const responseHi = await fetch(
    tvURL("release_date.desc", "35", "", "hi", "122")
  );
  const responseEn = await fetch(
    tvURL("release_date.desc", "35", "", "en", "122")
  );
